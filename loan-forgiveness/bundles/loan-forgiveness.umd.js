(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('ngx-mask')) :
    typeof define === 'function' && define.amd ? define('loan-forgiveness', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'ngx-mask'], factory) :
    (global = global || self, factory(global['loan-forgiveness'] = {}, global.ng.core, global.ng.common, global.ng.forms, global.ngxMask));
}(this, (function (exports, core, common, forms, ngxMask) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DataConverterService = /** @class */ (function () {
        ...
        DataConverterService.ɵprov = core.ɵɵdefineInjectable({ factory: function DataConverterService_Factory() { return new DataConverterService(core.ɵɵinject(common.DatePipe)); }, token: DataConverterService, providedIn: "root" });
    ...
    var LoanForgivCalcComponent = /** @class */ (function () {
        function LoanForgivCalcComponent(dataConverterService) {
            this.dataConverterService = dataConverterService;
            this.onSubmitEventEmit = new core.EventEmitter();
            this.onPeriodSelected = new core.EventEmitter();
            this.onPullETrans = new core.EventEmitter();
            this.percent = 0;
        ...
        LoanForgivCalcComponent.prototype.ngAfterViewChecked = function () {
            $('[data-toggle="popover"]').popover();
        };
        LoanForgivCalcComponent.prototype.ngOnInit = function () {
        ...
        LoanForgivCalcComponent.prototype.ngOnChanges = function (simpleChanges) {
        ...
        LoanForgivCalcComponent.prototype.convertAllObjects = function (simpleChanges) {
            for (var key in simpleChanges) {
        ...
        LoanForgivCalcComponent.prototype.buildForm = function () {
            if (this.form) {
                return;
            }
            this.form = new forms.FormGroup({
                start_date: new forms.FormControl('', [forms.Validators.required]),
                end_date: new forms.FormControl('', [forms.Validators.required]),
                payroll_cost: new forms.FormControl('', [forms.Validators.required]),
                mortgage_interest: new forms.FormControl('', [forms.Validators.required]),
                office_rent: new forms.FormControl('', [forms.Validators.required]),
                utilities: new forms.FormControl('', [forms.Validators.required]),
                existing_eidl: new forms.FormControl('', [forms.Validators.required]),
                additional_benefits: new forms.FormControl('', [forms.Validators.required]),
                non_payroll_cost_in_excess_of_25: new forms.FormControl({ value: 0, disabled: true }),
                no_of_fte: new forms.FormControl('', [forms.Validators.required]),
                no_of_fte_precovid: new forms.FormControl({ value: '', disabled: true }, [forms.Validators.required]),
                pay_cut_amount: new forms.FormControl(''),
                action: new forms.FormControl('head_count_analysis', [forms.Validators.required])
            });
        };
        LoanForgivCalcComponent.prototype.onFormChanges = function () {
            var _this = this;
            ...
            if (this.result && !this.result.disabled) {
                this.startDateChangeSubs = this.form.get('start_date').valueChanges.subscribe(function (start_date) {
                    var end_date = _this.get8WeekAhead(start_date);
                    var end_date_string = _this.dataConverterService.getTransformedDate(end_date, 'MMMM-dd');
                    var start_date_string = _this.dataConverterService.getTransformedDate(start_date, 'MMMM-dd');
                    _this.onPeriodSelected.emit({ start_date: start_date_string, end_date: end_date_string });
                    _this.form.get('end_date').setValue(end_date_string, { onlySelf: true, emitEvent: false });
                    _this.form.get('start_date').setValue(start_date_string, { onlySelf: true, emitEvent: false });
                });
                this.formChangeSubs = this.form.valueChanges.subscribe(function (values) {
                    if (_this.offer_data && _this.offer_data.no_of_employees) {
                        values.no_of_fte_precovid = _this.offer_data.no_of_employees;
                    }
                    if (_this.offer_data.loan_amount) {
                        values.loan_amount = _this.offer_data.loan_amount;
                    }
                    _this.updateExcessNonPyrlOf25();
                    if (values.action == 'payroll_analysis') {
                        if (values.no_of_fte) {
                            _this.form.get('no_of_fte').reset();
                        }
                        _this.form.get('no_of_fte').clearValidators();
                        if (_this.form.get('no_of_fte').invalid)
                            _this.form.get('no_of_fte').updateValueAndValidity();
                    }
                    else {
                        _this.form.get('no_of_fte').setValidators([forms.Validators.required]);
                    }
                    if (values.action == 'head_count_analysis') {
                        if (values.pay_cut_amount) {
                            _this.form.get('pay_cut_amount').reset();
                        }
                        _this.form.get('pay_cut_amount').clearValidators();
                        if (_this.form.get('pay_cut_amount').invalid)
                            _this.form.get('pay_cut_amount').updateValueAndValidity();
                    }
                    else {
                        _this.form.get('pay_cut_amount').setValidators([forms.Validators.required]);
                    }
                    _this.updateResultValues(values);
                });
            }
        };
        LoanForgivCalcComponent.prototype.updateResultValues = function (values) {
            if (!this.result || this.result.disabled) {
                return;
            }
            var forgivenessModel = new ForgivenessModel(__assign(__assign({}, values), { action: this.form.get('action').value }));
            this.loanForgiven = forgivenessModel.loanForgiveness;
            this.percent = forgivenessModel.actualPercentLeftOfFte;
        };
        LoanForgivCalcComponent.prototype.updateExcessNonPyrlOf25 = function () {
            var e_1, _a;
            var controlNames = ['mortgage_interest', 'office_rent', 'utilities'];
            var non_payroll_sum = 0;
            try {
                for (var controlNames_1 = __values(controlNames), controlNames_1_1 = controlNames_1.next(); !controlNames_1_1.done; controlNames_1_1 = controlNames_1.next()) {
                    var controlName = controlNames_1_1.value;
                ...
                try {
                    if (controlNames_1_1 && !controlNames_1_1.done && (_a = controlNames_1.return)) _a.call(controlNames_1);
                }
        ...
        LoanForgivCalcComponent.prototype.setFormValues = function (values) {
            var _values = {};
            ...
            this.form.patchValue(__assign({}, _values));
        };
        LoanForgivCalcComponent.prototype.disableForm = function () {
            if (this.form) {
                this.form.disable();
            }
            if (this.formChangeSubs) {
        ...
        LoanForgivCalcComponent.prototype.resetForm = function () {
        ...
        LoanForgivCalcComponent.prototype.onPullFromEtrans = function () {
            this.onPullETrans.emit();
        };
        LoanForgivCalcComponent.prototype.onSubmit = function () {
            if (!this.result || this.result.disabled) {
                return;
            }
            if (!this.form.invalid) {
                var loan_forgiven_amount = (this.loanForgiven !== undefined ? this.loanForgiven : 0);
                var percent = this.percent;
                var loan_amount_to_payback = ((loan_forgiven_amount == 0 || loan_forgiven_amount) && this.offer_data.loan_amount ? this.offer_data.loan_amount - loan_forgiven_amount : 0);
                if (loan_forgiven_amount < 0 || loan_amount_to_payback < 0) {
                    ...
                    this.onSubmitEventEmit.emit({ form_data: this.form.getRawValue(), result: { loan_forgiven_amount: loan_forgiven_amount, percent: percent, loan_amount_to_payback: loan_amount_to_payback } });
                }
            }
            else {
      ...
      */
        LoanForgivCalcComponent.prototype.validateAllFormFields = function (formGroup) {
            Object.keys(formGroup.controls).forEach(function (field) {
                var control = formGroup.get(field);
                control.markAsTouched({ onlySelf: true });
            });
            var formGroupInvalid = document.body.querySelectorAll('input.ng-invalid');
            formGroupInvalid[0].focus();
        };
        LoanForgivCalcComponent.prototype.get8WeekAhead = function (dateString) {
            var date;
            date = new Date(dateString);
            date.setDate(date.getDate() + 8 * 7);
            return date;
        };
        LoanForgivCalcComponent.prototype.getControlsConfg = function () {
            return [
        ...
        LoanForgivCalcComponent.prototype.getTransformedDate = function (val, format) {
            return this.dataConverterService.getTransformedDate(val, format);
        };
        LoanForgivCalcComponent.prototype.ngOnDestroy = function () {
            if (this.formChangeSubs) {
                this.formChangeSubs.unsubscribe();
            }
        ...
        return LoanForgivCalcComponent;
    }());
    ...
    exports.LoanForgivenessModule = LoanForgivenessModule;
    exports.ɵa = LoanForgivCalcComponent;
    exports.ɵb = DataConverterService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=loan-forgiveness.umd.js.map
